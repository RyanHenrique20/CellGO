...
**Descrição:** O sistema deverá permitir o cadastro dos clientes, mantendo os dados necessários para localizar vendas, emitir nota fiscal e processar solicitações de pós-venda. Pode ser pessoa física ou jurídica.
...
**Descrição:** O sistema deverá permitir o cadastro dos aparelhos disponíveis para venda.

**Regras:**
- Mínimo: modelo, marca, IMEI/número de série, condição (Novo/Seminovo), preço de venda, custo de aquisição, status inicial.
- IMEI/número de série único no sistema.
- Condição obrigatória - determina o período de garantia (RN-15).
- Entrada no estoque registra data, custo e identificador (RN-03).
- Cadastro restrito a funcionários autorizados, conforme nível de acesso (RN-22).
...
**Descrição:** Controle da disponibilidade individual de cada aparelho, sem reserva prévia à confirmação da venda.
...
**Descrição:** Validação da disponibilidade do aparelho no momento exato da finalização da venda.

**Regras:**
- Validação atômica junto com a confirmação do pagamento.
- Se já vendido por outra transação, nova tentativa é bloqueada e cliente informado.
